...
from intentkit.tools.jupiter.base import JupiterBaseTool
...
class JupiterGetPrice(JupiterBaseTool):
    ...
    def _get_common_tokens(self) -> dict[str, str]:
        ...
        # Actually I can access intentkit.tools.jupiter.base.COMMON_TOKENS
        from intentkit.tools.jupiter.base import COMMON_TOKENS
