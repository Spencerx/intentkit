...
from intentkit.tools.cryptopanic.base import CryptopanicBaseTool
...
Analyze these headlines for {currency}. Summarize trends, opportunities, and risks. Classify outlook as Bullish/Bearish with buy/sell/hold opinion. Provide concise analysis without headings.
    ...
    async def _arun(
        ...
        **kwargs,
        ...
        from intentkit.tools.cryptopanic.fetch_crypto_news import (
        ...
        news_tool = FetchCryptoNews()

        try:
            news_output: CryptopanicNewsOutput = await news_tool._arun(  # pyright: ignore[reportPrivateUsage]
