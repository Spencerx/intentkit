...
from intentkit.tools.opensea.constants import OPENSEA_API_BASE_URL
...
class OpenSeaApiMixin:
    ...
    Shared by both read-only and on-chain OpenSea tool base classes.
    """
...
class OpenSeaBaseTool(OpenSeaApiMixin, IntentKitTool):
    """Base class for read-only OpenSea API tools."""
