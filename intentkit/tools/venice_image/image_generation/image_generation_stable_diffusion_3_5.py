...
from intentkit.tools.venice_image.image_generation.image_generation_base import (
...
class ImageGenerationStableDiffusion35(VeniceImageGenerationBaseTool):
    ...
    name: str = "venice_image_generation_stable_diffusion_3_5"  # Different tool name
