...
of concerns keeps the core tool logic cleaner and easier to maintain.
"""
...
async def make_venice_api_request(
    ...
    Args:
        ...
        category: The category of the tool making the request (e.g., "venice_image"). Used for S3 storage and logging purpose.
        tool_name: The name of the tool or tool making the request (e.g., "image_generation"). Used for S3 storage and logging purpose.
