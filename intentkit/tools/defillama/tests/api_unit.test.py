...
class TestDefiLlamaAPI(unittest.IsolatedAsyncioTestCase):  # pyright: ignore[reportUninitializedInstanceVariable]
    ...
    async def asyncSetUp(self):
        ...
        self.datetime_patcher = patch("tools.defillama.api.datetime")  # pyright: ignore[reportUninitializedInstanceVariable]
    ...
    async def test_fetch_price_percentage_success(self):
        ...
        with patch("tools.defillama.api.datetime") as mock_datetime:
