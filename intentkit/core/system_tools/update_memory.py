"""Tool for updating agent long-term memory."""
...
class UpdateMemoryTool(SystemTool):
    """Tool for adding or updating the agent's long-term memory.

    This tool merges new information into the agent's existing long-term
