"""Skill to update the current user's profile."""
...
class UpdateUserProfileInput(BaseModel):
    """Input model for lead_update_user_profile skill."""
...
class UpdateUserProfileOutput(BaseModel):
    """Output model for lead_update_user_profile skill."""

    message: str = Field(description="Success message")
    updated_fields: list[str] = Field(description="List of fields that were updated")


class LeadUpdateUserProfile(LeadSkill):
    """Skill to update the current user's profile (name, timezone, language).
...
lead_update_user_profile_skill = LeadUpdateUserProfile()
