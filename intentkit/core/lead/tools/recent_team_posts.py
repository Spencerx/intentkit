"""Tool to read the team's recent post feed."""
...
class LeadRecentTeamPosts(LeadTool):
    """Tool to retrieve the team's recent posts from all subscribed agents."""
...
lead_recent_team_posts_tool = LeadRecentTeamPosts()
