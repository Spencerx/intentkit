...
class LeadGetAvailableLLMs(LeadTool):
    """Tool to retrieve list of available LLM models with details."""
...
lead_get_available_llms_tool = LeadGetAvailableLLMs()
