"""Tools for managing agent public info."""
...
class GetAgentLatestPublicInfoTool(ManagerTool):
    """Tool that retrieves the latest public info for the active agent."""
...
class UpdatePublicInfoTool(ManagerTool):
    """Tool to update the public info of an agent with partial field updates."""
...
get_agent_latest_public_info_tool = GetAgentLatestPublicInfoTool()
update_public_info_tool = UpdatePublicInfoTool()
