"""Tools for managing agent drafts."""
...
class GetAgentLatestDraftTool(ManagerTool):
    """Tool that retrieves the latest draft for the active agent."""
...
class UpdateAgentDraftTool(ManagerTool):
    """Tool to update agent drafts with partial field updates."""
...
get_agent_latest_draft_tool = GetAgentLatestDraftTool()
update_agent_draft_tool = UpdateAgentDraftTool()
