"""Tool for the manager agent to publish (or republish) the active agent."""
...
class PublishAgentTool(ManagerTool):
    """Tool to publish the active agent to public via the four-field form."""
    ...
    async def _arun(self, **kwargs: Any) -> str:
        ...
        # Mirrors UpdatePublicInfoTool: confirm ownership before mutating.
        try:
...
publish_agent_tool = PublishAgentTool()
