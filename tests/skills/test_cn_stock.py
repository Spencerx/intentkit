"""Tests for the cn_stock skill package."""
...
from intentkit.skills.cn_stock import Config, SkillStates, get_skills
from intentkit.skills.cn_stock.base import (
    CNStockBaseTool,
    market_of,
    normalize_a_share_symbol,
)
from intentkit.skills.cn_stock.get_announcement import GetAnnouncement
from intentkit.skills.cn_stock.get_board import GetBoard, GetBoardInput
from intentkit.skills.cn_stock.get_capital_flow import (
    GetCapitalFlow,
    GetCapitalFlowInput,
)
from intentkit.skills.cn_stock.get_financials import GetFinancials
from intentkit.skills.cn_stock.get_index import GetIndex, GetIndexInput
from intentkit.skills.cn_stock.get_kline import GetKLine, GetKLineInput
from intentkit.skills.cn_stock.get_news import GetNews, GetNewsInput
from intentkit.skills.cn_stock.get_quote import GetQuote, GetQuoteInput
...
def test_skill_metadata():
    ...
    for cls, expected_name in cases:
        ...
        assert skill.category == "cn_stock"
...
async def test_get_skills_filters_by_state():
    ...
    public_only = await get_skills(config, is_private=False)
    ...
    with_private = await get_skills(config, is_private=True)
...
async def test_run_blocking_uses_redis_cache_when_present():
    ...
    tool = GetQuote()
    with (
        patch("intentkit.skills.cn_stock.base.get_redis", return_value=fake_redis),
